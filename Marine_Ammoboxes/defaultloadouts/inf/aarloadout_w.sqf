...
//USMC Asst Autorifleman Woodland Loadout
 ...
 (unitBackpack _unit) additemCargo ["rhs_mag_30Rnd_556x45_Mk318_Stanag" ,11];
 (unitBackpack _unit) additemCargo ["rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red" ,10];
